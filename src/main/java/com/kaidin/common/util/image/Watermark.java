...
public class Watermark extends BaseImage {
    ...
    public static void pressImage(String imageFile, String watermarkImage, String position, Float degree) throws IOException {
        ...
        // 水印文件
        Image waterImage = ImageIO.read(new File(watermarkImage));
        int watermarkImageWidth = waterImage.getWidth(null);
        int watermarkImageHeight = waterImage.getHeight(null);
        ...
        graphic.drawImage(waterImage, watermarkImagePositionX, watermarkImagePositionY, watermarkImageWidth, watermarkImageHeight,
                null);
        // 水印文件结束
        graphic.dispose();
