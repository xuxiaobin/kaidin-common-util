...
public abstract class CollectionUtil {
	 ...
	 * @return
	 */
	public static <T> List<T> subList(List<T> dataList, int size) {
	 ...
	 * @return
	 */
	public static <T> List<T> subList(List<T> dataList, int fromIndex, int toIndex) {
	 ...
	 * @return
	 */
	public static Object decode(Object obj, Object defaultValue, Object expect1Obj, Object expect1Value,
                                Object... objArrray) {
